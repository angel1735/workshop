...
import { idlFactory } from './hotel_booking.did.js';
export { idlFactory } from './hotel_booking.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HOTEL_BOOKING;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hotel_booking.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hotel_booking canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hotel_booking.did.js")._SERVICE>}
 */
export const hotel_booking = createActor(canisterId);
