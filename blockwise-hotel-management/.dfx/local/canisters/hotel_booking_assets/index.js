...
import { idlFactory } from './hotel_booking_assets.did.js';
export { idlFactory } from './hotel_booking_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HOTEL_BOOKING_ASSETS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hotel_booking_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hotel_booking_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hotel_booking_assets.did.js")._SERVICE>}
 */
export const hotel_booking_assets = createActor(canisterId);
